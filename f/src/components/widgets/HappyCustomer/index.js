    ...
    <div className={styles.bg_holder}>
      ...
      <div className={styles.bg_content}>
        <div className={`container ${styles.bg_container}`}>
          <div
            className={`gap_big text_center ${styles.bg_box} ${aboutPage && styles.about_bg_box
              }`}
          >
            {/* normal home page de bunlar gorsenecek */}
            {!aboutPage && (
              <h2 className={styles.bg_box_title}>Happy Customer</h2>
            )}
            {/* {!aboutPage && (
              <>
...
styles: {
  ...
  `,
            ...
            {/* about page ucun ise asagidakilar gorsenecek */}
