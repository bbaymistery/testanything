...
export default async function handler(req, res) {
  if (req.method === "POST") {
    ...
    let log = await getmettingPointAsync(
      req.body.reservations[0].selectedPickupPoints[0]
    );

    let meetPoint =
      log.status === 200 && typeof log.data === "object"
        ? log.data["meet-point"]
        : "";
    let template = `
       <div style="float: left;width: 650px;">
           <div style="float: left; width: 650px;">
                                 <p><b>Dear ${req.body.reservations[0]?.passengerDetails
        ?.firstname
      }</b></p>
                                          ...
                                          style="border-collapse:collapse;font-size: 12px;">
                                                ...
                                                <tbody>
                                                 <tr style="width:100%;">
                                                     ...
                                                     <td style="padding:2px;padding-left: 3px ;width: 450px !important">${req.body.reservId[0][0]
      }</td>
                                                 </tr>
                                                 <tr style="width:100%;">
                                                     <td style="font-weight:bold;width: 200px !important;padding-left: 3px">Lead Passenger Name
                                                     </td>
                                                     <td style="padding:2px;padding-left: 3px;width: 450px !important">${req.body.reservations[0]
        ?.passengerDetails
        ?.firstname
      } </td>
                                                 </tr>
                                                 <tr style="width:100%;">
                                                     ...
                                                     <td style="padding:2px;width:450px !important">${req.body.reservations[0]
        ?.transferDetails
        ?.passengersNumber
      } </td>
                                                 </tr>
        ...
        ?.phone
                                                 ...
                                                 <tr style="width:100%;">
                                                     ...
                                                     <td style="padding:2px;padding-left: 3px;width: 450px !important"><a href="/compose?To=elgun1993%2d93@bk.ru">${req.body.reservations[0]
        ?.passengerDetails
        ?.email
      }
                                                     </a>
...
<!--transfer pick drop pointssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss -->
        ...
        (point) =>
          `
            ...
            : ""
                                                ...
                                                <tr style="width:100%;">
                                                    <td style="font-weight:bold;width: 200px !important;padding:2px 3px;">${req.body.reservations[0]
        ...
        .vehicleTypes[0]
                                                ...
                                                <tr style="width:100%;">
                                                    ...
                                                    <td style="min-height: 29px;padding:2px">${req.body.reservations[0]
        .transferDetails
        ?.specialRequests
      }</td>
                                                </tr>
...
${req.body?.reservations[1]?.quotation?.price
   ...
   <div style="float: left;width: 650px;">
          ...
          (point) =>
            `
              ...
              : ""
                                                ...
                                                <tr style="width:100%;">
                                                    <td style="font-weight:bold;width: 200px !important;padding:2px 3px;">${req.body.reservations[1]
          .selectedPickupPoints[0]
          ?.pcatId === 1
          ? "Flight"
          : ""
          ...
          .vehicleTypes[1]
                                                ...
                                                <tr style="width:100%;">
                                                    <td style="font-weight:bold;width: 200px !important;padding:2px 3px;">Special Requests</td>
                                                    <td style="min-height: 29px;padding:2px">${req.body.reservations[1]
          .transferDetails
          ?.specialRequests
        }</td>
                                                </tr>
  ...
  `
            ...
            <!-- return vooking details finish finish-->
                                    <!-- total price  -->
                                        <div style="float:left;width: 650px;font-family:Arial, Helvetica,Verdana sans-serif !important ;color:#666;">
                                               <span style="font-weight: 700;font-size:14px;padding-top:15px;"><br>Total Price : GBP  ${req.body?.reservations[1]
        ?.quotation?.price
        ? ` ${Number(
          req?.body
            .reservations[0]
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "info@aplcars.com", // generated ethereal user
        pass: "Istanbul2021!-", // generated ethereal password
      },
    ...
    const mailData = {
      ...
      subject: `Booking ${req.body.reservId[0][0]} ${req.body.reservId[0][1] ? "and " : ""
    ...
    transporter.sendMail(mailData, function (err, info) {
      if (err) {
        res.status(403).json({ status: "ERROR", err, template });
        console.log(err);
      } else {
        res.status(200).json({ status: "OK", info, template });
        console.log(info);
      }
    });
  }
