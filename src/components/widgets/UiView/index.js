          ...
          <div className={styles.feature_box}>
            <div className={styles.thumb}>
              <header className={styles.thumb_header}>
                <i className={` ${styles.thumb_icon}`}>
                  <Image src={"/icons/thumbs-up.svg"} alt="thumbs-up" width={20} height={20} />
                </i>
              </header>
            ...
            <div className={styles.thumb}>
              <header className={styles.thumb_header}>
                <i className={` ${styles.thumb_icon}`}>
                  <Image src={"/icons/briefcase.svg"} alt="briefcase" width={20} height={20} />
                </i>
              </header>
              <div className={styles.thumb_caption}>
                <h2 className={styles.thumb_title}>
            ...
            <div className={styles.thumb}>
              <header className={styles.thumb_header}>
                <i style={{ transform: "rotate(40deg)" }} className={` ${styles.thumb_icon}`}     >
                  <Image src={"/icons/plane-up.svg"} alt="-plane-up" width={20} height={20} />
                </i>
              </header>
              <div className={styles.thumb_caption}>
                <h2 className={styles.thumb_title}>
