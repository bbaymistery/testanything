            ...
            <div className={`${styles.linkname_description_section_section} page_section`}>
                <div className={`${styles.linkname_description_section_section_container} page_section_container`}>
                    <div className={styles.content}>
                        <h1 style={{ textAlign: "center", marginBottom: '1rem' }} >Heathrow Taxi Prices & information</h1>
                        <p>
                        ...
                        <hr />
                        <h2 style={{ textAlign: "center", marginBottom: '1rem', marginTop: '1rem' }}>4 ways to travel to and from Heathrow</h2>


                        <h3 style={{ textAlign: "center", }}> By Train </h3>
                        <p>
                        ...
                        <h4 style={{ textAlign: "center", }}>By Coach</h4>
                        <p>
                        ...
                        <h4 style={{ textAlign: "center", }}>By Bus</h4>
                        <p>
                        ...
                        <h4 style={{ textAlign: "center", }}>With Airport Pickups London Car service</h4>
                        ...
                        <ul>
                            <li><span dir={direction}></span><b>Heathrow Terminal 1=</b> &nbsp;
                                ...
                                front of the  domestic arrivals gate. Please click here for <a style={{ textDecoration: "underline" }} href="https://www.airport-pickups-london.com/Images/Heathrow_T1-Meeting-Point.jpg"
                            ...
                            <li><span dir={direction}></span><b>Heathrow Terminal 2=</b>   &nbsp; Meeting point for  international flights will be front of the Arrival Gate,
                                ...
                                arrivals gate. Please click here  for <a style={{ textDecoration: "underline" }} href="https://www.airport-pickups-london.com/Images/Heathrow_T2_Map-6.jpg" target="_blank"
                            ...
                            <li><span dir={direction}></span><b>   Heathrow Terminal 3=</b>  &nbsp;Meeting point is in front of  the WH Smith shop under the Heathrow
                                Terminal Welcome Board. Please click here  for <a style={{ textDecoration: "underline" }} href="https://www.airport-pickups-london.com/Images/Heathrow_T3-Meeting-Point.jpg"
                            ...
                            <li><span dir={direction}></span><b>Heathrow Terminal 4=</b> &nbsp; Meeting point is in front of  the Costa Coffee shop, which
                                is situated near to the arrivals gate. Please  click here for <a style={{ textDecoration: "underline" }} href="https://www.airport-pickups-london.com/Images/Heathrow_T4-Meeting-Point.jpg"
                            ...
                            <li><span dir={direction}></span><b>Heathrow Terminal 5=</b> Meeting point for  international flights will be outside the
                                ...
                                Please click here for <a style={{ textDecoration: "underline" }} href="https://www.airport-pickups-london.com/Images/Heathrow_T5-Meeting-Point.jpg" target="_blank" title="Heathrow terminal 5 Meeting Point">TERMINAL MAP </a></li>
                        </ul>
